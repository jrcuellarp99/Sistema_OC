...
<head>
    ...
    <title>INICIO CONTABILIDAD</title>
    ...
    <div class="container text-center">
        <div class="row position-absolute top-50 start-50 translate-middle">
            ...
            <div class="d-grid gap-2 col-6 mx-auto p-2">
                <button onclick="location.href='../acciones_generales/buscar_cont.php?rol=Administrador&area=<?php echo $area?>'" class="btn btn-primary">BUSCAR OC</button>      
            </div> 

            <div class="d-grid gap-2 col-6 mx-auto p-2">
                <button onclick="location.href='../acciones_generales/formulario_cont.php?rol=Administrador&area=<?php echo $area?>'" class="btn btn-primary">INSERTAR FORMULARIO DE OC</button>    
            </div> 
            
            <div class="d-grid gap-2 col-6 mx-auto p-2">
                <button onclick="location.href='../acciones_admin/actualizar_cont.php?rol=Administrador&area=<?php echo $area?>'" class="btn btn-primary">ACTUALIZAR UBICACIÓN DE OC</button>    
            </div> 
            <div class="d-grid gap-2 col-6 mx-auto p-2">
