...
//---------------------------------RECIBE TESORERIA = SI---------------------------------------------------------------------        
        ...
        $sql1 = "UPDATE bd_tesoreria SET rec_tes = ('$rec_tes') WHERE num_oc = '$num_oc'";
...
//--------------------------------HORA DE ACTUALIZACION Y CONFIRMACION BASE GENERAL--------------------------------------------------------------------------
        ...
        $sql4 = "UPDATE datos_oc SET rec_tes = ('$rec_tes'), fecha_rec_tes = ('$fecha_rec_adq') WHERE num_oc = '$num_oc'";
