<?php 
    ...
    $sql= "SELECT * FROM bd_contadores WHERE num_oc LIKE '%".$buscar."%' OR empresa LIKE '%".$buscar."%' OR unidad_de_negocio LIKE '%".$buscar."%' OR proveedor LIKE '%".$buscar."%' OR area_solicitante LIKE '%".$buscar."%'";
...
<thead>
        <tr style="background-color: #63C2E9; color:#ffffff;">
                ...
                <th style=" text-align: center;"> Recibe Cont </th>   
