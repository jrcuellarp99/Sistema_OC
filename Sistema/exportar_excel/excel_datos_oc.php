                                                                        ...
                                                                        <?php        
                                                                                ...
                                                                                <?php }else{
                                                                                        if(empty($_POST['buscar2'])){
                                                                                                $sql= "SELECT * FROM datos_oc WHERE num_oc LIKE '%".$buscar1."%' OR empresa LIKE '%".$buscar1."%' OR unidad_de_negocio LIKE '%".$buscar1."%' OR proveedor LIKE '%".$buscar1."%' OR area_solicitante LIKE '%".$buscar1."%' OR fecha_rec_adq_pos LIKE '%".$buscar1."%'";
                                                                                        }
