...
<?php
        ...
        if($area == "SegYMedAmbiente"){
                $indice = "SEG. Y MEDIO AMB.";
        }
        if($area == "Talento Humano"){
                $indice = "TALENTO HUMANO";
        }
        if($area == "Operaciones"){
                $indice = "OPERACIONES";
        }
                ...
                <div class="col-12 grid-margin">
                        <div class="card" style="background-color:#f0f0f0;">
                                <div class="card-body">
                                        ...
                                        <form id="form2" name="form2" method="POST" action="base_de_datos_area.php?rol=Usuario&area=<?php echo $area?>">
                                                <div class="col-12">
                                        ...
                                        <div class="row justify-content-between">
                                                <div class="d-grid gap-2 col-1 p-2 ">
                                                        <button onclick="location.href='../home_user/home_user.php?rol=Usuario&area=<?php echo $area?>'" class="btn btn-secondary btn-sm">VOLVER</button>
                                                        ...
                                                        <tbody>
                                                                        ...
                                                                        <?php        
                                                                                ...
                                                                                if(empty($_POST['buscar_oc']) && empty($_POST['buscar_empresa']) && empty($_POST['buscar_estacion']) && empty($_POST['buscar_proveedor']) && empty($_POST['buscar_areasolicitante'])){
                                                                                        ...
                                                                                        $sql= "SELECT * FROM datos_oc WHERE area_solicitante LIKE '%".$indice."%'";
                                                                                ...
                                                                                <?php }else{
                                                                                        //Busqueda de OC
                                                                                        if(!empty($_POST['buscar_oc']) && empty($_POST['buscar_empresa']) && empty($_POST['buscar_estacion']) && empty($_POST['buscar_proveedor'])){
                                                                                                $sql= "SELECT * FROM datos_oc WHERE num_oc LIKE '%".$buscar_oc."%' AND area_solicitante LIKE '%".$indice."%'";
                                                                                        }
                                                                                        //Busqueda de Empresa
                                                                                        if(!empty($_POST['buscar_empresa']) && empty($_POST['buscar_oc']) && empty($_POST['buscar_estacion']) && empty($_POST['buscar_proveedor'])){
                                                                                                $sql= "SELECT * FROM datos_oc WHERE empresa LIKE '%".$buscar_empresa."%' AND area_solicitante LIKE '%".$indice."%'";
                                                                                        }
                                                                                        //Busqueda de Estacion
                                                                                        if(!empty($_POST['buscar_estacion']) && empty($_POST['buscar_oc']) && empty($_POST['buscar_empresa']) && empty($_POST['buscar_proveedor'])){
                                                                                                $sql= "SELECT * FROM datos_oc WHERE unidad_de_negocio LIKE '%".$buscar_estacion."%' AND area_solicitante LIKE '%".$indice."%'";
                                                                                        }
                                                                                        //Busqueda de Proveedor
                                                                                        if(!empty($_POST['buscar_proveedor']) && empty($_POST['buscar_oc']) && empty($_POST['buscar_estacion']) && empty($_POST['buscar_empresa'])){
                                                                                                $sql= "SELECT * FROM datos_oc WHERE proveedor LIKE '%".$buscar_proveedor."%' AND area_solicitante LIKE '%".$indice."%'";
                                                                                        }                                                                                        
