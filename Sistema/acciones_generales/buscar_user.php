    ...
    <div class="container">
        ...
        <div class="row"> 
            <div class="d-grid gap-2 col-6 mx-auto p-2">
                    <button onclick="location.href='../home_user/home_user.php?rol=Usuario&area=<?php echo $area?>'" class="btn btn-secondary">VOLVER</button>    
                    <button onclick="location.href='../logica_descarga/logica_descarga.php?num_oc=<?php echo $rowSql['num_oc']; ?>&rol=Usuario&area=<?php echo $area?>'" class="btn btn-primary">DESCARGAR COMPROBANTE</button>
            </div> 
        </div>
