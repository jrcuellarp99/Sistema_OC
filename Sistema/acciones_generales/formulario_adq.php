...
<body style="background-color:#f0f0f0;">
    ...
    <div class="container bg-success p-2 text-dark bg-opacity-10 p-2">
        ...
        <form action="../auxiliares/insertar_adq.php" method="POST" class="row">
                <div class="col-12">
                ...
                <div class="col-6">
                    <div class="input-box">
                        ...
                        <input type="text" name="fecha_pago"  class="form-control" required>
                    </div>                    
                </div>
                ...
                <div class="col-6">
                    <div class="input-box">
                        ...
                        <input type="text" name="devolver_pago"  class="form-control" required>
                    </div>                    
                </div>
