                ...
                <div class="col-12 grid-margin">
                        <div class="card" style="background-color:#f0f0f0;">
                                <div class="card-body">
                                        ...
                                        <form id="form2" name="form2" method="POST" action="actualizar_ger.php?rol=Administrador&area=<?php echo $area?>">
                                                <div class="col-8">
                                                        <div class="input-group mb-3">
                                                                ...
                                                                <label class="input-group-text">RECIBE GER:</label>
                                                                <select class="form-select" name="buscar2">
                                                                        <option value="">RECIBE GERENCIA</option>
                                                        ...
                                                        <tbody>
                                                                        ...
                                                                        <?php        
                                                                                ...
                                                                                <tr>
                                                                                        ...
                                                                                        <td style=" text-align: center;"><?php echo $rowSql['rec_ger']; ?><br><button type="button" style="width: 20px; height: 15px;" id="<?php echo $rowSql['num_oc']; ?>" ></button></td>
                                                                                        ...
                                                                                        <script> 
                                                                                                ...
                                                                                                checkbox<?php echo $rowSql['num_oc']; ?>.addEventListener('click', function () {
                                                                                                                ...
                                                                                                                window.location.href = '../logica_actualizar/log_act_ger.php?num_oc=<?php echo $rowSql['num_oc']; ?>';
                                                                                ...
                                                                                <?php }else{
                                                                                        if(empty($_POST['buscar2'])){
                                                                                                $sql= "SELECT * FROM bd_gerencia WHERE num_oc LIKE '%".$buscar1."%' OR empresa LIKE '%".$buscar1."%' OR unidad_de_negocio LIKE '%".$buscar1."%' OR proveedor LIKE '%".$buscar1."%' OR area_solicitante LIKE '%".$buscar1."%'";
                                                                                        }
                                                                                        if(empty($_POST['buscar1'])){
                                                                                                $sql= "SELECT * FROM bd_gerencia WHERE rec_ger LIKE '%".$buscar2."%'";
                                                                                        }
                                                                                        if(!empty($_POST['buscar1']) && !empty($_POST['buscar2'])){
                                                                                                $sql= "SELECT * FROM bd_gerencia WHERE rec_ger LIKE '%".$buscar2."%' AND num_oc LIKE '%".$buscar1."%' OR rec_ger LIKE '%".$buscar2."%' AND empresa LIKE '%".$buscar1."%' OR rec_ger LIKE '%".$buscar2."%' AND unidad_de_negocio LIKE '%".$buscar1."%' OR rec_ger LIKE '%".$buscar2."%' AND proveedor LIKE '%".$buscar1."%' OR rec_ger LIKE '%".$buscar2."%' AND area_solicitante LIKE '%".$buscar1."%'";
                                                                                        }
                                                                                $numeroSql = mysqli_query($conexion_adq1,$sql); 
